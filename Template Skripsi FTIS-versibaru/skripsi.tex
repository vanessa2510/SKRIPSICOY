...
\newcommand{\vstaENG}{FINAL PROJECT}
...
\nottoggle{vbimbingan}{
	...
	\begin{center}
		...
		SIMULATOR PERTUMBUHAN WIRAUSAHA BERBASIS CELLULAR AUTOMATA\\\vspace{2.5cm}
		\includegraphics{Logo-UNPAR}\\\vspace{1cm}
		\uppercase{Vanessa Sukamto}\\\vspace{0.5cm}
		NPM: 2014730010 \\
		\vfill
...
\nottoggle{vsidang}{
	...
	\begin{center}
		...
		SIMULATOR OF ENTREPRENEURIAL GROWTH BASED ON CELLULAR AUTOMATA\\\vspace{2.5cm}
		\includegraphics{Logo-UNPAR}\\\vspace{1cm}
		\uppercase{Vanessa Sukamto}\\\vspace{0.5cm}
		NPM: 2014730010 \\
		\vfill
...
This simulator is implemented in a computer. Simulator testing is done with functional testing, parameter reading testing, file input testing and the result of the simulation testing. The result of these tests, the simulator can run well and as expected.} \vskip 1cm		
		{\noindent \textbf{Keywords: Entrepreneurial Cellular Automata, Cellular Automata, The Growth of Entrepreneurship, GEM} } 
	\end{abstract}			
	\cleardoublepage
