...
\iftoggle{develop}{ 
	...
	ECA (\textit{Entrepreneurial Cellular Automata}) merupakan pengembangan dari \textit{Cellular Automata} standar yang diusulkan oleh Ulam dan von Neumann. Pengembangan model dari ECA ini yaitu pada sel, ketetanggaan, fungsi transisi state dan fungis transformasi. ECA ini diusulkan oleh Nugraheni dan Natali \cite{ECA}. ECA dikembangkan dengan mengacu pada model kewirausahaan dari Global Entrepreneurship Monitor (GEM).\\
	\textit{Continuity Index}}
