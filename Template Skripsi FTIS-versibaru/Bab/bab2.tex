...
\hline
\end{tabular}
\label{tabelIndikator1}
\end{table}

\begin{table}[H]
\centering
\caption{Lanjutan Indikator Kewiausahaan}
\begin{tabular}{|p{4cm}|p{10cm}|}
\hline
