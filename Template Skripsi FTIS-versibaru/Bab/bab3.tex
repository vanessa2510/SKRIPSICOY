...
\begin{tabular}{|c|p{1cm}|p{1cm}|p{1cm}|p{1cm}|p{2cm}|p{1cm}|p{2cm}|p{1cm}|c|}
\hline
&Jenis Kelamin&Umur&Usia Bisnis&Kateg-ori&Sub Kategori&\textit{Educa-tion}&Lokasi&\textit{Income}&Level\\
\hline
E1 & P & 18th & 0 & Minum-an & Minuman bersoda & SMP & Medan & 5-7jt & Nascent\\
\hline
E2 & W & 30th & 0 & Tas & Tas anak-anak  & SMA & Pekanbaru & 3-5jt & New\_bm\\
\hline
E3 & W & 45th & 0 & Makan-an & Makanan berat & SD & Palembang & 7-9jt & New\_bm\\
\hline
\end{tabular}
\end{table}
...
Masing-masing tetangga relasinya yaitu sama dengan.
	...
	\begin{figure} [H]
		\centering  
		\includegraphics[width=11cm, height=7cm]{t=0} 
...
\end{multline}
	...
	\begin{figure} [H]
		\centering  
		\includegraphics[width=11cm, height=7cm]{t=3} 
